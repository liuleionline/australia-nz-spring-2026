  ...
  const days = [
    ...
    },
    {
      ...
      schedule:[
        ...
        {time:"12:00–12:15", title:"还车与前往航站楼", notes:"为找还车点、接驳和国际安检留出缓冲。", query:"Christchurch Airport car rental returns"},
      ...
      highlights:[
        {name:"还车前车况", tag:"证据照片", notes:"油表、里程、车身四角、车内和还车位再次拍照，保留至押金退回。", photoTip:"照片带时间信息；把加油小票与租车合同一起保存。", query:"Christchurch Airport car rental returns", image:"https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=82"},
