(function () {
  ...
  const hotels = [
    ...
    { id:"tekapo", date:"9.26", nights:1, city:"Lake Tekapo / Takapō", name:"New peaceful / warm / family friendly Unit B", address:"35 Andrew Don Drive, Lake Tekapo 7999", price:3892.76, facts:["2卧优先","停车方便","整套房"], image:commons("Church of the Good Shepherd at Lake Tekapo.jpg"), map:q("35 Andrew Don Drive Lake Tekapo"), link:"https://www.airbnb.cn/rooms/1234979367439107795?source_impression_id=p3_1788771291_P3mGSz0E1SjX9huV", note:"入住15:00，退房10:00。", lat:-44.0010, lng:170.4748 },
    { id:"twizel", date:"9.27", nights:1, city:"Twizel", name:"A True Family House", address:"206 Mackenzie Drive, Twizel 7901", price:2142.40, facts:["4卧","2卫","免费停车"], image:commons("NZ Hooker Valley track.jpg"), map:q("206 Mackenzie Drive Twizel"), link:"https://www.airbnb.cn/rooms/26610263?source_impression_id=p3_1788771297_P3Blx044XysMwoH5", note:"空间充足；页面提示个人洗护用品可能需自备。", lat:-44.2595, lng:170.0983 },
    { id:"wanaka", date:"9.28–29", nights:2, city:"Wānaka", name:"Cosy home with indoor fireplace / outdoor patio", address:"70B Matai Road, Wānaka 9305", price:5817, facts:["2晚","壁炉","庭院停车"], image:commons("Lake wanaka.jpg"), map:q("70B Matai Road Wanaka"), link:"https://www.airbnb.cn/rooms/638009211870028013?source_impression_id=p3_1788771303_P35wqA2wMvXpn11B", note:"入住9.28，退房9.30。", lat:-44.6827, lng:169.1368 },
    { id:"queenstown", date:"9.30–10.1", nights:2, city:"Queenstown", name:"Queenstown Mountain View Retreat", address:"44 Goldfield Heights, Queenstown 9300", price:5165.73, facts:["2晚","山景","停车方便"], image:commons("Queenstown - Wakatipu Lake & Remarkables Mountains View from Skyline Gondola Observation Deck.jpg"), map:q("44 Goldfield Heights Queenstown"), link:"https://www.airbnb.cn/rooms/1691172239380274952?source_impression_id=p3_1788771312_P3hvK-08FnL2WWSI", note:"离CBD约10分钟车程；进城优先公共停车场。", lat:-45.0257, lng:168.6901 },
    { id:"teanau", date:"10.2–3", nights:2, city:"Te Anau", name:"Relaxing Te Anau Retreat", address:"8 Lawson Burrows Crescent, Te Anau 9600", price:3342.08, facts:["2晚","整套房","车位"], image:commons("00 1373 Milford Sound -New Zealand.jpg"), map:q("8 Lawson Burrows Crescent Te Anau"), link:"https://www.airbnb.cn/rooms/1328515587337095762?source_impression_id=p3_1788771318_P3Y45GORkYcZF6cr", note:"米尔福德出发基地；10.3出发前务必加满油。", lat:-45.4044, lng:167.7237 },
    { id:"haast", date:"10.4", nights:1, city:"Haast", name:"Beachfront Paradise: The Black Moth", address:"35 Fox Moth Drive, Haast 7886", price:2682.72, facts:["海边","免费停车","整套房"], image:commons("NZ - Knights Point - Haast Pass - Obelisk.jpg"), map:q("35 Fox Moth Drive Haast"), link:"https://www.airbnb.cn/rooms/1195345556254873961?source_impression_id=p3_1788771327_P3XRHVwAWYK52Ntw", note:"长途转场后的休息站；提前在Wānaka/Makarora补给。", lat:-43.8518, lng:169.0135 },
    { id:"franz", date:"10.5", nights:1, city:"Franz Josef / Waiau", name:"TWO FOUR CRON · Downtown 2 Bedroom Premium Stay", address:"24 Cron Street, Franz Josef / Waiau 7886（请以订单页最终门牌为准）", price:1824.80, facts:["2卧","2卫","免费停车 / EV"], image:commons("Franz Josef Glacier, New Zealand (5).JPG"), map:q("24 Cron Street Franz Josef"), link:"https://www.airbnb.cn/rooms/1192646002050539125?source_impression_id=p3_1788771334_P36_nadRAyE7y_M5", note:"市中心，餐厅步行方便；保留现有订单。", lat:-43.3887, lng:170.1843 },
    { id:"hokitika", date:"10.6", nights:1, city:"Hokitika", name:"Hoki Boatshed Accommodation", address:"2 Revell Street, Hokitika 7810", price:1891.17, facts:["海边位置","4人","停车"], image:commons("Hokitika Gorge (3).jpg"), map:q("2 Revell Street Hokitika"), link:"https://www.airbnb.cn/rooms/1431569775284311748?source_impression_id=p3_1788771344_P304UpbeiYRmgRQW", note:"入住15:00，退房11:00；适合日落后去Glow Worm Dell。", lat:-42.7151, lng:170.9651 },
    { id:"castlehill", date:"10.7", nights:1, city:"Castle Hill", name:"Castle Hill现代宽敞度假屋", address:"3 Bevel Court, Castle Hill Village 7580", price:2421.06, facts:["3卧","2卫","免费停车"], image:commons("Kura Tāwhiti, Castle Hill, Canterbury, New Zealand.jpg"), map:q("3 Bevel Court Castle Hill New Zealand"), link:"https://www.airbnb.cn/rooms/1565659033496668162?source_impression_id=p3_1788771355_P3w5tQdoYoVA6cxZ", note:"已调整为10月7日入住；山区别墅，附近餐饮很少，抵达前买好晚餐和早餐。", lat:-43.2270, lng:171.7118 },
    { id:"chc-final", date:"10.8–9", nights:2, city:"基督城市中心", name:"第6套：漫步到体育场 · 2卧2卫 · 预留停车位", address:"187 Kilmore Street, Christchurch Central, Christchurch 8013, New Zealand", price:"", facts:["2卧","2卫","King + 2张单人床","预留车位"], image:commons("Christchurch Botanic Gardens in autumn.jpg"), map:q("187 Kilmore Street Christchurch 8013 New Zealand"), link:"https://www.airbnb.cn/rooms/1241368912811080729?source_impression_id=p3_1788771363_P371M7qGGPXucCMB", note:"已确认预订；10月8–10日入住。第6套房源总价待从订单补录。", lat:-43.5230, lng:172.6260 }
  ];
