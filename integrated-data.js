(function () {
  ...
  data.hotels.forEach((hotel) => {
    ...
    hotel.user = null;
    hotel.shen = null;
    hotel.note = "价格、订单号、房间分配与分摊信息仅由登录后的私有 API 提供。";
  });
  ...
  data.accounting = {
    ...
    lodgingUser: 0,
    lodgingShen: 0,
    tripLedger: { total: 0, mySpend: 0, myPaid: 0, myReceivable: 0 },
    expenses: [],
    notes: ["详细账本、付款人、参与人、票据和结算关系仅在参与者登录后由私有 API 提供。"]
  };
  ...
  data.meta.lodgingRule = "详细住宿金额与分摊规则仅在参与者登录后显示。";
})();
